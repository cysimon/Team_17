...
public class EventBus
{
    ...
    public static void Publish<T>(T published_event, ref int subCount)
    {
        ...
        if (_topics.ContainsKey(t))
        {
            ...
            // MATT:
            /* subCount is pass by reference and number of subscribers is assigned to variable, use if needed */
            subCount = subscriber_list.Count;
    ...
    {
        int temp = 0;
        Publish<T>(published_event, ref temp);
    }
